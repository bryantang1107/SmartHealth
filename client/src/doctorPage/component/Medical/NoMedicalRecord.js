...
const NoMedicalRecord = () => {
  ...
  return (
    <div className="no-appointment">
      <main className="no-appointment-main-container">
        <div className="no-appointment-container">
          <svg
            className="no-appointment-svg"
            version="1.1"
  ...
  s33.181,12.591,38.725,16.498c2.387,1.682,3.461,4.668,2.705,7.488L380.857,346.164z"
    ...
    278.436,375.599 383.003,264.076 364.393,251.618 264.807,364.928 				"
        ...
        <div className="no-appointment-content">
          <h1>You Do not possess any medical record</h1>
          <p>Consult a doctor now to get your medical record</p>
