    ...
    >
      <div className="contact-header">
        <div className="contact-content">
          <h1>Contact Us</h1>
          <p>Let's Keep In Touch ! Feel free to drop us an email :)</p>
          <a
            href="mailto:smarthealthgroup22@gmail.com"
            className="btn green"
            style={{ textTransform: "none" }}
          >
            smarthealthgroup22@gmail.com
          </a>
        </div>
      </div>
      <div className="contact-faq">
        ...
        <ul style={{ listStyleType: "revert" }}>
          ...
          <li>
            Click the chat button located at bottom right corner of the window
            to chat with admin
          </li>
        </ul>
        <img src={chat} alt="" />
      ...
      <div className="contact-hero">
        <Yoursvg className="svg-contact"></Yoursvg>
